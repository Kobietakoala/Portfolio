            ...
            @if(isset($profileData['experience']) && count($profileData['experience']) > 0)
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                        @foreach($profileData['experience'] as $companyId => $group)
                            @foreach($group['experiences'] as $index => $experience)
                                <tr>
                                    @if($index === 0)
                                        <td rowspan="{{ count($group['experiences']) }}" class="align-middle fw-bold">
                                            @if(!empty($group['company_url']))
                                                <a href="{{ $group['company_url'] }}"
                                                   target="_blank"
                ...
                <div class="d-block d-md-none mt-4">
                    @foreach($profileData['experience'] as $companyId => $group)
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                @foreach($group['experiences'] as $experience)
